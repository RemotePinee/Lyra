          ...
          <div className="p-5">
            ...
            <div className="mt-5 flex items-center justify-end gap-2">
              <button
                ...
                className="h-[30px] rounded-lg border border-line px-3 text-[12.5px] text-ink-muted transition-colors duration-150 hover:bg-card-hover hover:text-ink"
              >
                取消
              </button>
              <button
                ...
                className="h-[30px] rounded-lg bg-danger px-3 text-[12.5px] font-medium text-shell transition-opacity duration-150 hover:opacity-90"
              >
                开启完全访问权限
              </button>
            </div>
